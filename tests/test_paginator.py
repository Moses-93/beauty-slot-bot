...
def test_middle_page():
    ...
    callbacks = extract_callback_data(markup)
    assert "paginate:test:0:5" in callbacks
    assert "paginate:test:10:5" in callbacks
