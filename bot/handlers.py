...
async def start(message: Message):
    ...
    set_user_data(user_id, name=message.from_user.first_name, username=message.from_user.username)
...
async def confirm_the_entry(callback: CallbackQuery):
    ...
    add_notes(user.get('name'), user.get('username'), time, user.get('date'), user.get('service'))
    await callback.message.answer(
